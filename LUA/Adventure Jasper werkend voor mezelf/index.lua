...
imageWood.file_name = "C:/Users/Gebruiker/Desktop/Da vinci opdrachten/Jaar 1/LUA/Adventure Jasper/images/bosKey.jpg"
...
function buttonC1:on_click()
  ...
  -- Follow gandalf to the finish
    ...
    if (buttonC1.text == "Follow him") then
        imageWood.file_name = "C:/Users/Gebruiker/Desktop/Da vinci opdrachten/Jaar 1/LUA/Adventure Jasper/images/finish.png";
        level = 8;
        levelChecker();
    end;
  ...
  -- Watcher with gem
    ...
    if(buttonC1.text == "Show the gem" and label3.text == "Gem") then
        imageWood.file_name = "C:/Users/Gebruiker/Desktop/Da vinci opdrachten/Jaar 1/LUA/Adventure Jasper/images/watchergem.jpg";
        level = 7;
        levelChecker();
    end;
  ...
  -- Go to watcher
    ...
    if(buttonC1.text == "Follow the path" and label3.text == "Gem") then
        imageWood.file_name = "C:/Users/Gebruiker/Desktop/Da vinci opdrachten/Jaar 1/LUA/Adventure Jasper/images/watcher.jpg";
        level = 6;
        levelChecker();
    end;
  ...
  -- Open the chest
    ...
    if(buttonC1.text == "Open the chest" and label1.text == "Key") then
        imageWood.file_name = "C:/Users/Gebruiker/Desktop/Da vinci opdrachten/Jaar 1/LUA/Adventure Jasper/images/level2.jpg";
        level = 5;
        levelChecker();
        label3.text = "Gem";
        far = true;
  ...
  -- At start
    ...
    if(buttonC1.text == "Go into the forest" and label2.text ~= "Chest" and label3.text ~= "Gem") then
        imageWood.file_name = "C:/Users/Gebruiker/Desktop/Da vinci opdrachten/Jaar 1/LUA/Adventure Jasper/images/level2chest.jpg";
        level = 3;
        levelChecker();
    end;
...
function buttonC3:on_click()
    ...
    if(buttonC3.text == "Take the key") then
      ...
      levelChecker();
      label1.text = "Key"
      imageWood.file_name = "C:/Users/Gebruiker/Desktop/Da vinci opdrachten/Jaar 1/LUA/Adventure Jasper/images/bos.png"
    end;
